<html>
    ...
    *{
    ...
    <ul class="menu">
      ...
      <li><a href="/atp3project/home/mobile" style="background-color:red">Mobile & its Accessory</a></li>
    ...
    <div class="spanMen">
        {Items_pictureS}
        <span><a href="http://localhost/atp3project/product_detail/GetshowDetails?catagory=mobile&id={P_id}">
