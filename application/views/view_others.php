<html>
    ...
    *{
    ...
    <ul class="menu">
      ...
      <li><a href="/atp3project/home/others" style="background-color:red">Others</a></li>

    </ul>
    <div class="spanMen">
        {Items_pictureS}
        <span><a href="http://localhost/atp3project/product_detail/GetshowDetails?catagory=others&id={P_id}">
