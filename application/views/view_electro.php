<html>
    ...
    *{
    ...
    <ul class="menu">
      ...
      <li><a href="/atp3project/home/electronics" style="background-color:red">Electronics</a></li>
      <li><a href="/atp3project/home/others">Others</a></li>

    </ul>
    <div class="spanMen">
        {Items_pictureS}
        <span><a href="http://localhost/atp3project/product_detail/GetshowDetails?catagory=electronics&id={P_id}">
