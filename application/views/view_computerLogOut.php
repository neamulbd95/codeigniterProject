<html>
    ...
    *{
    ...
    <ul class="menu">
      ...
      <li><a href="/atp3project/home/computer" style="background-color:red">Computer</a></li>
    ...
    <div class="spanMen">
        {Items_pictureS}
        <span><a href="http://localhost/atp3project/product_detail/GetshowDetails?catagory=computer&id={P_id}">
