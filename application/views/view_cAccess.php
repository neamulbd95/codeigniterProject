<html>
   ...
   #LogOutBu{
    ...
    <ul class="menu">
      ...
      <li><a href="/atp3project/home/cAccess" style="background-color:red">Computer Accessory</a></li>
    ...
    <div class="spanMen">
        {Items_pictureS}
        <span><a href="http://localhost/atp3project/product_detail/GetshowDetails?catagory=computer_accessory&id={P_id}">
