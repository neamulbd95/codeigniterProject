<html>
    ...
    *{
    ...
    <ul class="menu">
      ...
      <li><a href="/atp3project/home/women" style="background-color:red">Women</a></li>
    ...
    <div class="spanMen">
    {Items_pictureS}
        <span><a href="http://localhost/atp3project/product_detail/GetshowDetails?catagory=women&id={P_id}">
