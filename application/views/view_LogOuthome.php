        ...
        <script type="text/javascript">
            function ajaxSearch() {
                ...
                if (input_data.length === 0) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "http://localhost/atp3project/search/autocomplete",
                        data: post_data,
    ...
    <h1 class="nameWeb"><a href="/atp3project/home">DorDam</a></h1>
        ...
        <div class="something">
            ...
            <input name="search_data" id="search_data" class="" value="" 
                   data-label="Search for a property, a unit, or an resident..." type="text" placeholder="Search.." onkeyup="ajaxSearch();"/>
            <div id="suggestions">
